...
def load_rows(filename):
    ...
    return clean_rows, skipped, attempted
 
 
def print_report(clean_rows, skipped, attempted):
...
if __name__ == "__main__":
    clean_rows, skipped, attempted = load_rows(FILENAME)
    if clean_rows or skipped:
        print_report(clean_rows, skipped, attempted)